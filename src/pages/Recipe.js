...
function Recipe() {
    ...
    return(
        <>
  <button className='btn btn-primary d-flex justify-content-start' onClick={goBack}>Go Back</button>
            {!recipe.idMeal ? <Loader/> :(
                <div className='recipe'>
                    ...
                    <button onClick={handleRecipeShow} className="btn btn-success">Show Recipe</button>
                    ...
                    {recipe.strYoutube ? (
                        <div className="">
                            ...
                            <h5 className='mt-5'>Video Recipe</h5>
